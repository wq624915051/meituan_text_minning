...
cookies_list = [{'domain': '.meituan.com',
                ...
                'path': '/',
                'secure': False,
                'value': '17bb6d2c1a5c8-0429b21620d03f-c343365-144000-17bb6d2c1a512'},
                {'domain': '.meituan.com',
                'httpOnly': True,
                'name': 'token2',
                'path': '/',
                'secure': False,
                'value': '3iV3ni3PW5eix0BPUnF6JGRzJN4AAAAAcw4AAPBW26ELr22UPJb3PrMURnuRTHcoOWJ_bDXytM50ZRTq72Ix9I8pvOptL-v_iCm49A'},
                {'domain': '.meituan.com',
                'expiry': 1662395870,
                'httpOnly': False,
                'name': '_hc.v',
                'path': '/',
                'secure': False,
                'value': 'ebe46672-ed73-f036-de4c-e9cd2f3c7f20.1630859871'},
                {'domain': '.meituan.com',
                'expiry': 1631464661,
                'httpOnly': False,
                'name': 'mtcdn',
                ...
                'secure': False,
                'value': '1630859870841'},
                {'domain': 'wh.meituan.com',
                'expiry': 1630946271,
                'httpOnly': True,
                'name': 'client-id',
                'path': '/',
                'secure': False,
                'value': '9984362a-3815-488e-8988-aefb060dad3d'},
                {'domain': '.meituan.com',
                'expiry': 1630861671,
                'httpOnly': False,
                'name': '_lxsdk_s',
                'path': '/',
                'secure': False,
                'value': '17bb6d2c1a6-87f-767-6fe%7C%7C2'},
                {'domain': '.meituan.com',
                'httpOnly': True,
                'name': 'n',
                'path': '/',
                ...
                'path': '/',
                'secure': False,
                'value': '64c5cff664b24af0b1a5.1630859861.1.0.0'},
                {'domain': '.meituan.com',
                'httpOnly': False,
                'name': 'u',
                'path': '/',
